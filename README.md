...
tests/               26 tests, waarvan een de site tegen de database aanhoudt
```
...
- Er is nog geen enkele fetcher. `terra.nightly` plant wel al correct wat aan de
  beurt is, op basis van `source.next_due`.
